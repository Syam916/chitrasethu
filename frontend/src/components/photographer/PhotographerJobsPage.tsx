...
const PhotographerJobsPage = () => {
  ...
  // Fetch current photographer ID
  useEffect(() => {
    const fetchPhotographerId = async () => {
      try {
        const profile = await photographerService.getMyProfile();
        setCurrentPhotographerId(profile.photographerId);
      } catch (error) {
                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          ...
                          {/* Only show applicants count if this job was posted by the current photographer */}
                          {currentPhotographerId && job.photographerId === currentPhotographerId && (
                            <div className="flex items-center space-x-2 text-sm">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                  ...
                  {/* Only show applicants count if this job was posted by the current photographer */}
                  {currentPhotographerId && selectedJob.photographerId === currentPhotographerId && (
                    <>
