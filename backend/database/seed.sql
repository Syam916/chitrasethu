-- ============================================================================
-- CHITRASETHU DATABASE SEED DATA
-- Version: 1.0.0
-- Date: 2024-10-25
...
('customer', 'Customer', 'Regular customer who can book photographers', '{"can_book": true, "can_review": true, "can_post": true, "can_message": true}'),
('photographer', 'Photographer', 'Professional photographer providing services', '{"can_book": false, "can_review": true, "can_post": true, "can_message": true, "can_manage_portfolio": true, "can_manage_availability": true}'),
('admin', 'Administrator', 'Platform administrator with full access', '{"can_book": true, "can_review": true, "can_post": true, "can_message": true, "can_manage_users": true, "can_manage_content": true, "can_view_analytics": true}'),
('moderator', 'Moderator', 'Content moderator', '{"can_moderate_posts": true, "can_moderate_reviews": true, "can_manage_reports": true}');
...
-- Hash: $2a$10$Ikxb/lz5C.EbcexlQNcc2.KZV5Xj5Rj/uvHdw26XfSe4vLexSmuKq
...
-- User Profiles
INSERT INTO user_profiles (user_id, full_name, avatar_url, bio, phone, city, state, country) VALUES
-- Customers
...
INSERT INTO photographers (user_id, business_name, specialties, experience_years, base_price, rating, total_reviews, equipment, languages, is_verified, is_premium) VALUES
(4, 'Arjun Kapoor Photography', '["Wedding", "Portrait", "Traditional", "Candid"]', 8, 15000.00, 4.8, 156, '["Canon EOS R5", "Sony A7 III", "Professional Lighting"]', '["Hindi", "English", "Marathi"]', TRUE, TRUE),
(5, 'Priya Sharma Studios', '["Fashion", "Events", "Commercial", "Editorial"]', 10, 25000.00, 4.9, 203, '["Nikon D850", "Medium Format Camera", "Studio Lighting"]', '["Hindi", "English", "Punjabi"]', TRUE, TRUE),
(6, 'Vikram Singh Photography', '["Corporate", "Wedding", "Events", "Business"]', 6, 18000.00, 4.7, 98, '["Canon EOS 5D", "Professional Flash", "Drone Camera"]', '["Hindi", "English", "Kannada"]', TRUE, FALSE),
(7, 'Ananya Mehta Creations', '["Portrait", "Family", "Kids", "Maternity"]', 4, 12000.00, 4.6, 142, '["Sony A7R IV", "Portrait Lenses", "Natural Lighting"]', '["Tamil", "English", "Hindi"]', TRUE, FALSE);

-- ============================================================================
-- 4. PHOTOGRAPHER PORTFOLIOS
-- ============================================================================

INSERT INTO photographer_portfolios (photographer_id, image_url, title, description, category, display_order, is_featured) VALUES
...
INSERT INTO event_categories (category_name, slug, description, icon, color_code, display_order) VALUES
...
INSERT INTO events (creator_id, category_id, title, description, event_date, event_time, location, city, state, expected_attendees, min_budget, max_budget, status) VALUES
...
INSERT INTO bookings (customer_id, photographer_id, event_id, booking_date, booking_time, duration_hours, location, event_type, total_amount, advance_amount, pending_amount, status, payment_status) VALUES
...
INSERT INTO booking_payments (booking_id, amount, payment_type, payment_method, payment_status, transaction_id, payment_gateway, payment_date) VALUES
...
INSERT INTO booking_reviews (booking_id, photographer_id, customer_id, rating, review_text) VALUES
...
INSERT INTO posts (user_id, content_type, caption, media_urls, location, tags, likes_count, comments_count) VALUES
(4, 'gallery', 'Captured this beautiful moment at yesterday\'s wedding ceremony. The emotions, the colors, the pure joy - everything was perfect! 📸✨', '["https://images.unsplash.com/photo-1519741497674-611481863552", "https://images.unsplash.com/photo-1606216794074-735e91aa2c92"]', 'Grand Palace Hotel, Mumbai', '["Wedding", "Photography", "Mumbai", "Love"]', 1247, 89),
(5, 'image', 'Behind the scenes of today\'s fashion shoot! The magic happens when creativity meets passion. 🎬👗', '["https://images.unsplash.com/photo-1469334031218-e382a71b716b"]', 'Fashion Studio, Delhi', '["Fashion", "BTS", "Studio", "Photography"]', 892, 67),
(6, 'image', 'Corporate headshots that tell a story. Professional photography isn\'t just about the camera - it\'s about connecting with your subject. 💼📷', '["https://images.unsplash.com/photo-1511285560929-80b456fea0bc"]', 'Business District, Bangalore', '["Corporate", "Portrait", "Professional"]', 634, 42),
(7, 'image', 'Birthday celebrations are about capturing joy in its purest form! This little one\'s smile made my day ✨🎂', '["https://images.unsplash.com/photo-1578662996442-48f60103fc96"]', 'Rainbow Gardens, Chennai', '["Birthday", "Kids", "Family", "Joy"]', 456, 34),
(4, 'gallery', 'Pre-wedding magic at Goa beaches! Sometimes the best shots happen when couples forget about the camera and just be themselves 🌅💕', '["https://images.unsplash.com/photo-1606216794074-735e91aa2c92", "https://images.unsplash.com/photo-1519741497674-611481863552"]', 'Seaside Resort, Goa', '["PreWedding", "Beach", "Romance", "Goa"]', 978, 56);
...
INSERT INTO collections (user_id, title, description, thumbnail_url, images, category, is_public, likes_count) VALUES
(4, 'Best Wedding Shots 2024', 'Curated collection of the most beautiful wedding moments from this year', 'https://images.unsplash.com/photo-1519741497674-611481863552', '["https://images.unsplash.com/photo-1519741497674-611481863552", "https://images.unsplash.com/photo-1606216794074-735e91aa2c92", "https://images.unsplash.com/photo-1511285560929-80b456fea0bc"]', 'Wedding', TRUE, 234),
(5, 'Fashion Portfolio 2024', 'High-end fashion photography showcase', 'https://images.unsplash.com/photo-1469334031218-e382a71b716b', '["https://images.unsplash.com/photo-1469334031218-e382a71b716b", "https://images.unsplash.com/photo-1509631179647-0177331693ae"]', 'Fashion', TRUE, 189),
(6, 'Corporate Event Highlights', 'Professional event photography collection', 'https://images.unsplash.com/photo-1511578314322-379afb476865', '["https://images.unsplash.com/photo-1511578314322-379afb476865", "https://images.unsplash.com/photo-1505373877841-8d25f7d46678"]', 'Corporate', TRUE, 156),
(7, 'Family Moments', 'Capturing beautiful family memories', 'https://images.unsplash.com/photo-1519340241574-2cec6aef0c01', '["https://images.unsplash.com/photo-1519340241574-2cec6aef0c01", "https://images.unsplash.com/photo-1578662996442-48f60103fc96"]', 'Family', TRUE, 198);

-- ============================================================================
-- 14. MESSAGES
-- ============================================================================

INSERT INTO messages (sender_id, receiver_id, message_text, is_read, read_at) VALUES
...
-- ============================================================================
-- 16. PHOTOGRAPHER AVAILABILITY (Sample for next 30 days)
-- ============================================================================

-- Arjun Kapoor - Available slots
INSERT INTO photographer_availability (photographer_id, date, time_slot, start_time, end_time, is_available) VALUES
...
UNION ALL
SELECT 'Photographer Portfolios', COUNT(*) FROM photographer_portfolios
UNION ALL
...
UNION ALL
SELECT 'Booking Payments', COUNT(*) FROM booking_payments
UNION ALL
SELECT 'Booking Reviews', COUNT(*) FROM booking_reviews
UNION ALL
...
UNION ALL
SELECT 'Photographer Availability', COUNT(*) FROM photographer_availability;
