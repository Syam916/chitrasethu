...
BEGIN
    ...
    RAISE NOTICE '✅ Added 8 new tables: photo_booth_galleries, photo_booth_gallery_photos, photo_booth_access_logs, collection_likes, collection_comments, board_collaborators, job_posts, job_applications';
